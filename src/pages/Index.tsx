      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <section className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent">
            Universal Crypto Alias Resolver
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-4">
            Instantly resolve crypto aliases to wallet addresses across ENS, DNS TXT records, Lightning Network, 
            Unstoppable Domains, Handshake, and 10+ more naming systems.
          </p>
        ...
        <section className="mt-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
            {[
              ...
              <div key={system} className="flex items-center gap-2 p-3 rounded-lg bg-card/50 border border-border/50">
